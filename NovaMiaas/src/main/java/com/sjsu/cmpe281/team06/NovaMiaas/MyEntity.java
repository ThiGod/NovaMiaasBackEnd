...
public class MyEntity {
	...
	public static final String SQL_URL = "54.200.72.126";
	public static final String SQL_USERNAME = "group6";
	public static final String SQL_PASSWORD = "sjsugroup6";
	...
	public static final String UBUNTU_GET_IP_SH_PATH = "/home/thigod/Documents/dev/getIP.sh";
}
